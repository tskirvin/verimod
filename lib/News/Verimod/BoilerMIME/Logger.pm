$VERSION = "0.50";
package News::Verimod::BoilerMIME::Logger;
our $VERSION = "0.50";
...
News::Verimod::BoilerMIME::Logger - log boilerplate articles into mbox files

=head1 SYNOPSIS

  use News::Verimod::BoilerMIME::Logger qw( log_approve log_reject );  
...
### Version History ###########################################################
###############################################################################
# 0.50		Fri 09 Mar 19:37:14 CST 2007    tskirvin
### I disliked News::Verimod::Mbox; this will work better.
